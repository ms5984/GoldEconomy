...
public class InventoryBankOptions extends Menu {
    ...
    public void setMenuItems() {
        ...
        ItemStack s1;
        s1 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &eTRANSFER FROM WALLET &7x1", "Click to deposit in quantities of 1.");
        s1.setAmount(1);
        ItemStack s32;
        s32 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &eTRANSFER FROM WALLET &7x32", "Click to deposit in quantities of 32.");
        s32.setAmount(32);
        ItemStack s64;
        s64 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &eTRANSFER FROM WALLET &7x64", "Click to deposit in quantities of 64.");
        s64.setAmount(64);
        inventory.setItem(10, s1);
        inventory.setItem(11, s32);
        inventory.setItem(12, s64);
        ItemStack b1;
        b1 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &6TRANSFER TO WALLET &7x1", "Click to withdraw in quantities of 1.");
        b1.setAmount(1);
        ItemStack b32;
        b32 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &6TRANSFER TO WALLET &7x32", "Click to withdraw in quantities of 32.");
        b32.setAmount(32);
        ItemStack b64;
        b64 = makeItem(ItemLibrary.getMaterial(manager.getItemToEdit()), "&b&l" + currency.replace("INGOT", manager.getItemToEdit()) + " &r| &6TRANSFER TO WALLET &7x64", "Click to withdraw in quantities of 64.");
        b64.setAmount(64);
        inventory.setItem(14, b1);
        inventory.setItem(15, b32);
        inventory.setItem(16, b64);
        ItemStack ss1;
        ss1 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &eTRANSFER FROM WALLET &7x1", "Click to deposit in quantities of 1.");
        ss1.setAmount(1);
        ItemStack ss32;
        ss32 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &eTRANSFER FROM WALLET &7x32", "Click to deposit in quantities of 32.");
        ss32.setAmount(32);
        ItemStack ss64;
        ss64 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &eTRANSFER FROM WALLET &7x64", "Click to deposit in quantities of 64.");
        ss64.setAmount(64);
        inventory.setItem(19, ss1);
        inventory.setItem(20, ss32);
        inventory.setItem(21, ss64);
        ItemStack bb1;
        bb1 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &6TRANSFER TO WALLET &7x1", "Click to withdraw in quantities of 1.");
        bb1.setAmount(1);
        ItemStack bb32;
        bb32 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &6TRANSFER TO WALLET &7x32", "Click to withdraw in quantities of 32.");
        bb32.setAmount(32);
        ItemStack bb64;
        bb64 = makeItem(ItemLibrary.getMaterial(manager.getItemTooEdit()), "&b&l" + scurrency.replace("NUGGET", manager.getItemTooEdit()) + " &r| &6TRANSFER TO WALLET &7x64", "Click to withdraw in quantities of 64.");
        bb64.setAmount(64);
