...
public class InventoryPlayerAdd extends EcoMenu {
    ...
    switch (mat) {
        ...
        case RED_WOOL:
            amount = 500;
            Bukkit.dispatchCommand(p,"eco give " + name + " " + amount);
            break;
        case ORANGE_WOOL:
            amount = 1000;
            Bukkit.dispatchCommand(p,"eco give " + name + " " + amount);
    ...
    public void setMenuItems() {
        ItemStack a1 = makeItem(Material.RED_WOOL, "&b&l500", "", "&a&oAdd &d&n500 &a&oto their balance");
        ItemStack a2 = makeItem(Material.ORANGE_WOOL, "&b&l1,000", "", "&a&oAdd &d&n1,000 &a&oto their balance");
        ItemStack a3 = makeItem(Material.YELLOW_WOOL, "&b&l2,500", "", "&a&oAdd &d&n2,500 &a&oto their balance");
        ItemStack a4 = makeItem(Material.LIME_WOOL, "&b&l5,000", "", "&a&oAdd &d&n5,000 &a&oto their balance");
        ItemStack a5 = makeItem(Material.GREEN_WOOL, "&b&l8,500", "", "&a&oAdd &d&n8,500 &a&oto their balance");
        ItemStack a6 = makeItem(Material.BLUE_WOOL, "&b&l10,000", "", "&a&oAdd &d&n10,000 &a&oto their balance");
        ItemStack a7 = makeItem(Material.LIGHT_BLUE_WOOL, "&b&l500,000 :)", "", "&a&oAdd &d&n500,000 &a&oto their balance");
